 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.SERIAL_API_SOFT_RESET)
public class ZWaveFunctionSerialApiSoftResetHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionSerialApiSoftResetHandler.class);
