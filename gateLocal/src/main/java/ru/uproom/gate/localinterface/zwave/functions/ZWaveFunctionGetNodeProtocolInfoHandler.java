 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.GET_NODE_PROTOCOL_INFO)
public class ZWaveFunctionGetNodeProtocolInfoHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionGetNodeProtocolInfoHandler.class);
