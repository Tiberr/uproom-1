 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.PROMISCUOUS_APPLICATION_COMMAND_HANDLER)
public class ZWaveFunctionPromiscuousApplicationCommandHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionPromiscuousApplicationCommandHandler.class);
