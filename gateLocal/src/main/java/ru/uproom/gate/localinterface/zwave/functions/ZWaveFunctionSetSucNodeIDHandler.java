 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.SET_SUC_NODE_ID)
public class ZWaveFunctionSetSucNodeIDHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionSetSucNodeIDHandler.class);
