 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.SET_PROMISCUOUS_MODE)
public class ZWaveFunctionSetPromiscuousNodeHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionSetPromiscuousNodeHandler.class);
