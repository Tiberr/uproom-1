 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.MEMORY_GET_BYTE)
public class ZWaveFunctionMemoryGetByteHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionMemoryGetByteHandler.class);
