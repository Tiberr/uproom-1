 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.ASSIGN_RETURN_ROUTE)
public class ZWaveFunctionAssignReturnRouteHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionAssignReturnRouteHandler.class);
