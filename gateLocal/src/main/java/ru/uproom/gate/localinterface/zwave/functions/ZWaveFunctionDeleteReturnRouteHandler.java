 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.DELETE_RETURN_ROUTE)
public class ZWaveFunctionDeleteReturnRouteHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionDeleteReturnRouteHandler.class);
