 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.REPLICATION_SEND_DATA)
public class ZWaveFunctionReplicationSendDataHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionReplicationSendDataHandler.class);
