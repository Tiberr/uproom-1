 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.READ_MEMORY)
public class ZWaveFunctionReadMemoryHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionReadMemoryHandler.class);
