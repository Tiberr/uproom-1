 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.ENABLE_SUC)
public class ZWaveFunctionEnableSucHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionEnableSucHandler.class);
