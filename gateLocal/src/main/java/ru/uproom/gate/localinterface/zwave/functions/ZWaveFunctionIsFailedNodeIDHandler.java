 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.IS_FAILED_NODE_ID)
public class ZWaveFunctionIsFailedNodeIDHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionIsFailedNodeIDHandler.class);
