 ...
 */
public class ZWaveSwitchDeviceParameter extends ZWaveDeviceParameter {
    ...
    public ZWaveSwitchDeviceParameter(
            ZWaveDevice device,
            ZWaveCommandClass commandClass,
            DeviceParametersNames serverName
    ) {
        super(device, commandClass, ZWaveDeviceParameterNames.Switch, serverName);
    }
