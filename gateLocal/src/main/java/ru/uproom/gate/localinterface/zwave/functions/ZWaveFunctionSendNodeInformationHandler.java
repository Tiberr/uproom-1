 ...
 */
@ZWaveFunctionHandlerAnnotation(value = ZWaveFunctionID.SEND_NODE_INFORMATION)
public class ZWaveFunctionSendNodeInformationHandler implements ZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(ZWaveFunctionSendNodeInformationHandler.class);
