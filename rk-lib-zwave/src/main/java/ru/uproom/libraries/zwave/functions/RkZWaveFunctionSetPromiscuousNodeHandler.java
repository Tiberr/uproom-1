 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.SET_PROMISCUOUS_MODE)
public class RkZWaveFunctionSetPromiscuousNodeHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionSetPromiscuousNodeHandler.class);
