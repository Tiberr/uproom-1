 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.DELETE_RETURN_ROUTE)
public class RkZWaveFunctionDeleteReturnRouteHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionDeleteReturnRouteHandler.class);
