 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.PROMISCUOUS_APPLICATION_COMMAND_HANDLER)
public class RkZWaveFunctionPromiscuousApplicationCommandHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionPromiscuousApplicationCommandHandler.class);
