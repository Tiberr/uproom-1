 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.SET_SUC_NODE_ID)
public class RkZWaveFunctionSetSucNodeIDHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionSetSucNodeIDHandler.class);
