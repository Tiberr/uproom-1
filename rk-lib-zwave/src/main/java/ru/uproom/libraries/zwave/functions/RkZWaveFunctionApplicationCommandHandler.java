 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.APPLICATION_COMMAND)
public class RkZWaveFunctionApplicationCommandHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionApplicationCommandHandler.class);
    ...
    public boolean execute(RkZWaveMessageTypes messageType, int[] parameters,
        ...
        pool.getDevicePool().applyDeviceParametersFromIntArray(parameters);
