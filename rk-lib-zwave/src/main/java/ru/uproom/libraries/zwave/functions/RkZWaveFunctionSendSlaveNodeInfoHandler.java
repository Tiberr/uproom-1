 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.SEND_SLAVE_NODE_INFO)
public class RkZWaveFunctionSendSlaveNodeInfoHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionSendSlaveNodeInfoHandler.class);
