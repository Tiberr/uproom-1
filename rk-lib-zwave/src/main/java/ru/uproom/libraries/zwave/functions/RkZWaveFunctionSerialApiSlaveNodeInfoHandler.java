 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.SERIAL_API_SLAVE_NODE_INFO)
public class RkZWaveFunctionSerialApiSlaveNodeInfoHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionSerialApiSlaveNodeInfoHandler.class);
