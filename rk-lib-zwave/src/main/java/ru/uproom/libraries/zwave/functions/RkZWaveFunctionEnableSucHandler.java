 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.ENABLE_SUC)
public class RkZWaveFunctionEnableSucHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionEnableSucHandler.class);
