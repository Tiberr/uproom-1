 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.SET_LEARN_MODE)
public class RkZWaveFunctionSetLearnModeHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionSetLearnModeHandler.class);
