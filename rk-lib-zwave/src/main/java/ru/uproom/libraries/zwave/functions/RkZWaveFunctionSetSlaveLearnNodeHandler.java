 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.SET_SLAVE_LEARN_MODE)
public class RkZWaveFunctionSetSlaveLearnNodeHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionSetSlaveLearnNodeHandler.class);
