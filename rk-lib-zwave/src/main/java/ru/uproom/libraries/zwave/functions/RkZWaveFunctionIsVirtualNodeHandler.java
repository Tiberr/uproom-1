 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.IS_VIRTUAL_NODE)
public class RkZWaveFunctionIsVirtualNodeHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionIsVirtualNodeHandler.class);
