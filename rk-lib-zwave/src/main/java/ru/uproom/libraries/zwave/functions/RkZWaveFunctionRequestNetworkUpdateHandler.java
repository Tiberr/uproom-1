 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.REQUEST_NETWORK_UPDATE)
public class RkZWaveFunctionRequestNetworkUpdateHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionRequestNetworkUpdateHandler.class);
