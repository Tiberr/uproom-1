 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.SERIAL_API_SOFT_RESET)
public class RkZWaveFunctionSerialApiSoftResetHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionSerialApiSoftResetHandler.class);
