 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.REPLACE_FAILED_NODE)
public class RkZWaveFunctionReplaceFailedNodeHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionReplaceFailedNodeHandler.class);
