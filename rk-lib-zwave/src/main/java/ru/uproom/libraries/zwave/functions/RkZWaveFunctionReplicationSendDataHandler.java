 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.REPLICATION_SEND_DATA)
public class RkZWaveFunctionReplicationSendDataHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionReplicationSendDataHandler.class);
