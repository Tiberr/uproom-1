 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.GET_VIRTUAL_NODES)
public class RkZWaveFunctionGetVirtualNodesHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionGetVirtualNodesHandler.class);
