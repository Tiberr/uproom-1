 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.SET_DEFAULT)
public class RkZWaveFunctionSetDefaultHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionSetDefaultHandler.class);
