 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.APPLICATION_SLAVE_COMMAND_HANDLER)
public class RkZWaveFunctionApplicationSlaveCommandHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionApplicationSlaveCommandHandler.class);
