 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.SEND_SLAVE_DATA)
public class RkZWaveFunctionSendSlaveDataHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionSendSlaveDataHandler.class);
