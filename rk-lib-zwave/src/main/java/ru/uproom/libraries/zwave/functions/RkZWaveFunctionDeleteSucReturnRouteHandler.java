 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.DELETE_SUC_RETURN_ROUTE)
public class RkZWaveFunctionDeleteSucReturnRouteHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionDeleteSucReturnRouteHandler.class);
