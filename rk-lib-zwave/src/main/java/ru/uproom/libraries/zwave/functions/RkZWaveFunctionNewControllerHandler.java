 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.NEW_CONTROLLER)
public class RkZWaveFunctionNewControllerHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionNewControllerHandler.class);
