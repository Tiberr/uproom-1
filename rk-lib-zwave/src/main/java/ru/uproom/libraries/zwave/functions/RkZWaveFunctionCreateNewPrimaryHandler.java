 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.CREATE_NEW_PRIMARY)
public class RkZWaveFunctionCreateNewPrimaryHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionCreateNewPrimaryHandler.class);
