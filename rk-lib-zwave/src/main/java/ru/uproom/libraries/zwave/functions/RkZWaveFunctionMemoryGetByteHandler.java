 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.MEMORY_GET_BYTE)
public class RkZWaveFunctionMemoryGetByteHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionMemoryGetByteHandler.class);
