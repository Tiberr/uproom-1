 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.REPLICATION_COMMAND_COMPLETE)
public class RkZWaveFunctionReplicationCommandCompleteHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionReplicationCommandCompleteHandler.class);
