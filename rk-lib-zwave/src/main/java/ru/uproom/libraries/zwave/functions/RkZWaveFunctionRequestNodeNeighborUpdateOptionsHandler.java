 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.REQUEST_NODE_NEIGHBOR_UPDATE_OPTIONS)
public class RkZWaveFunctionRequestNodeNeighborUpdateOptionsHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionRequestNodeNeighborUpdateOptionsHandler.class);
