 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.REQUEST_NODE_NEIGHBOR_UPDATE)
public class RkZWaveFunctionRequestNodeNeighborUpdateHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionRequestNodeNeighborUpdateHandler.class);
