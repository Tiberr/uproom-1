 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.CONTROLLER_CHANGE)
public class RkZWaveFunctionControllerChangeHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionControllerChangeHandler.class);
