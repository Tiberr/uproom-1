 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.R_F_POWER_LEVEL_SET)
public class RkZWaveFunctionRfPowerSetLevelHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionRfPowerSetLevelHandler.class);
