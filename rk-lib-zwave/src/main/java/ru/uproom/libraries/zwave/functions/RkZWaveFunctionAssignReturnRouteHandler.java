 ...
 */
@RkZWaveFunctionHandlerAnnotation(value = RkZWaveFunctionID.ASSIGN_RETURN_ROUTE)
public class RkZWaveFunctionAssignReturnRouteHandler implements RkZWaveFunctionHandler {


    private static final Logger LOG =
            LoggerFactory.getLogger(RkZWaveFunctionAssignReturnRouteHandler.class);
